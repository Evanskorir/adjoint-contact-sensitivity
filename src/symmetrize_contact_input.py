...
class SymmetricContactMatrixInput:
    def __init__(self, n_age: int, pop: torch.Tensor, contact_matrix: torch.Tensor):
        """
        ...
        Args:
            ...
            contact_matrix (torch.Tensor): The transformed original contact matrix.
        """
        self.n_age = n_age
        self.pop = pop
        self.contact_matrix = contact_matrix

    def create_symmetric_matrix(self) -> torch.Tensor:
        """
        ...
        new_sym_contact_mtx[upper_tri_idx[0], upper_tri_idx[1]] = self.contact_matrix
